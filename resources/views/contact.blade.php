<!-- 
 ...
 -->
  ...
  <a href="index"><button style="color: aliceblue;background-color:black;">Back to Site</button></a>
        <div id="w3f__widget--content"
        class="font-bold text-center text-2xl text-indigo-500 " style="margin-left: -180px;" >Fill Our Email To Contact Us On : mahajansmriti8@gmail.com</div>
        @error('message')
    {{ $message }}
    @enderror 
        <div
